...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.output_folder = join(self.output_folder_base, f'fold_{fold}'+"training_log_%d_%d_%d_%02.0d_%02.0d_%02.0d.txt" %
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        # flops = profile(self.network, (data,))
        # print('flops:',flops )
        # print('net total parameters:', sum(param.numel() for param in self.network.parameters()))
